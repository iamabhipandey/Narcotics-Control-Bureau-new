                ...
                <div className="header-main-branding">
                    <div className="container branding-container">
                        <div className="branding-left">
                            <Link to="/" className="branding-emblem-link">
                                <img src="/national-emblem.png" alt="National Emblem" className="gov-emblem" />
                            </Link>
                        ...
                        <div className="branding-right-group">
                            ...
                            <div className="branding-logo-right">
                                <img src="/logo.svg" alt="NCB Seal" className="ncb-logo-right" />
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <nav className={`main-nav ${isMenuOpen ? "show-sidebar" : ""}`}>
                            ...
                            <div className="sidebar-header">
                                <div className="sidebar-brand">
                                    <img src="/national-emblem.png" alt="National Emblem" className="sidebar-logo" />
